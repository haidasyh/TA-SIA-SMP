                ...
                <div class="mb-4">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <p class="text-muted">Tambahkan user baru</p>
                        </div>
                                ...
                                <div>
                                    @foreach($roles as $role)
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="roles[]" value="{{ $role->name }}" id="role-{{ $role->id }}" data-role="{{ $role->name }}" {{ in_array($role->name, old('roles', [])) ? 'checked' : '' }}>
