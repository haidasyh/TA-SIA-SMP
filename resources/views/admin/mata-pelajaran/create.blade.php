            ...
            <div class="col-lg-10 dashboard-content">
                <div class="mb-4">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h1 class="fw-bold">Tambah Mata Pelajaran</h1>
                            <p class="text-muted">Tambahkan mata pelajaran baru</p>
                        </div>
                        ...
                        <form method="POST" action="{{ route('admin.mata-pelajaran.store') }}">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="kode_mapel" class="form-control @error('kode_mapel') is-invalid @enderror" value="{{ old('kode_mapel') }}" required>
                                    @error('kode_mapel')
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" name="kkm" class="form-control @error('kkm') is-invalid @enderror" value="{{ old('kkm', 75) }}" min="0" max="100">
                                    @error('kkm')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
