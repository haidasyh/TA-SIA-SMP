                ...
                <div class="mb-4">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <p class="text-muted">Edit data siswa</p>
                        </div>
                        ...
                        <form method="POST" action="{{ route('admin.siswa.update', $siswa->id) }}">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="no_hp_ortu" class="form-control @error('no_hp_ortu') is-invalid @enderror" value="{{ old('no_hp_ortu', $siswa->no_hp_ortu) }}">
                                    @error('no_hp_ortu')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
